...
1. Confirm hands-on is done: `lab.events` exists, you inspected `metadata/` and `data/` in MinIO, and you completed the **Break it** section (or ran `./reset.sh --confirm` afterward). Optional notebook: `lab/notebooks/01_basics.ipynb`.
