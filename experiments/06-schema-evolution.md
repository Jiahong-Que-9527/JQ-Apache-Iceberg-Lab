...
1. Confirm hands-on is done: add/rename/drop schema changes applied without rewriting old Parquet. Optional notebook: `lab/notebooks/03_schema_evolution.ipynb`.
